...
@section('content')
    <div class="">
        <h4 class="mb-4 text-2xl font-semibold text-gray-600 dark:text-gray-300">Dashboard</h4>
    </div>
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
        <div class="flex justify-between bg-primary-600 shadow-sm border border-gray-300 rounded-lg h-36 p-5">
            <div>
                <p class="mb-4 text-white">Total Orders</p>
                <p class="mb-4 text-white text-3xl font-semibold">{{ $orderItemCount }}</p>
            </div>
        ...
        <div class="flex justify-between bg-primary-600 shadow-sm border border-gray-300 rounded-lg h-36 p-5">
            <div>
                ...
                <p class="mb-4 text-white text-3xl font-semibold">{{ $total_sale . ' Ks' }}</p>
            </div>
        ...
        <div class="flex justify-between bg-primary-600 shadow-sm border border-gray-300 rounded-lg h-36 p-5">
            <div>
                ...
                <p class="mb-4 text-white text-3xl font-semibold">{{ $itemCount }}</p>
            </div>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="size-16 text-white opacity-30">
                <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="flex justify-between bg-primary-600 shadow-sm border border-gray-300 rounded-lg h-36 p-5">
            <div>
                ...
                <p class="mb-4 text-white text-3xl font-semibold">{{ $orderCount }}</p>
            </div>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="size-16 text-white opacity-30">
                <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <section class="flex gap-4 mb-4">
        ...
        <div class="NewOrderTable bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden w-2/3 p-6">
