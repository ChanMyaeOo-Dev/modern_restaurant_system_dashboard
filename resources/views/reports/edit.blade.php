    ...
    <section class="bg-white dark:bg-gray-900 shadow rounded-md p-6">
        <div class="">
            <div class="flex items-center justify-between mb-4">
                <h2 class="text-xl font-bold text-gray-900 dark:text-white">Edit Item</h2>
                ...
                <div class="flex flex-col items-end">
                    ...
                    <div class="flex items-center gap-4 h-[240px] w-full mb-4">
                        <div id="preview" class="h-full aspect-square">
                            <img id="photo" src="{{ $item['photo'] }}" alt="preview"
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6 w-full mb-4">
                        <div class="sm:col-span-2">
                            ...
                            <input type="text" name="name" id="name"
                                ...
                                placeholder="Type Item name" required="" value="{{ $item['name'] }}">
                        </div>
                    </div>
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6 w-full">
                        ...
                        <div class="w-full">
                            ...
                            <input type="number" name="price" id="price"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="$2999" required="" value="{{ $item['price'] }}">
                        </div>
                        <div class="sm:col-span-2">
                            ...
                            <textarea id="description" name="description" rows="8"
                                ...
                                placeholder="Your description here">{{ $item['description'] }}</textarea>
                        </div>
                    </div>
                    {{-- New Area --}}
                    <button type="submit"
